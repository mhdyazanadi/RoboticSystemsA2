...
volatile long count_e0; // used by encoder to count the rotation   //count_e1 left  count_e0 right
...
ISR( INT6_vect ) {
  ...
  switch (state_e0) {
    ...
    case 14:
      count_e0 = count_e0 - 1;
      //Serial.print("ISR acctived, count_e0 = ");
...
ISR( PCINT0_vect ) {
  ...
  switch (state_e1) {
    ...
    case 14:
      count_e1 = count_e1 - 1;
      //Serial.print("ISR acctived, count_e1 = ");
